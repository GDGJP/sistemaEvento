			...
			<form method="post" action="" id="validation-form-formulario" class="form-horizontal categoriaForm" enctype="multipart/form-data">
				<fieldset>
					<div class="control-group">
						<label class="control-label" for="nome" >Participante</label>
						<div class="controls">
							<select id="listaParticipantes" name="idParticipante">
								<?php 
									foreach( $participantes as $participante ) : 
										$objetoParticipante = json_decode($participante->respostas);
								?>
										<option value="<?php echo $participante->id; ?>" ><?php echo $objetoParticipante->nome; ?></option>
								<?php 
									endforeach;
								?>
							</select>

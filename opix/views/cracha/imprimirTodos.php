...
<head>
	...
	<?php foreach($divisaoCrachas as $indice => $crachas) : ?>
			<table class="folha <?php echo ($indice > 1) ? 'margintop' : ''; ?>" cellspacing="0" cellpadding="0" >
				<?php foreach( $crachas as $indice => $linhaCracha ) : ?>
					<tr>
						<?php foreach( $linhaCracha as $cracha ) : ?>
							<?php 

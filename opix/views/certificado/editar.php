			...
			<form method="post" action="" id="validation-form-categoria" class="form-horizontal categoriaForm" enctype="multipart/form-data">
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" name="nome" id="nome" value="<?php echo $certificado->nome; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="texto">Texto</label>
						<div class="controls">
							<textarea class="texto" name="texto" id="texto" ><?php echo $certificado->texto; ?></textarea>
						</div>
					</div>

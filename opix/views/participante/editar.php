			...
			<form method="post" id="validation-form-categoria" class="form-horizontal" enctype="multipart/form-data">
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" required="required" name="nome" value="<?php echo $participante->nome; ?>" />
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php foreach($listaFuncoes as $indice => $label) : ?>
								<option <?php echo ($participante->funcao == $indice) ? 'selected="selected"' : ''; ?> value="<?php echo $indice; ?>" ><?php echo $label; ?></option>
							<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="email" class="input-large" required="required" name="email" id="email" value="<?php echo $participante->email; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="telefone" >Telefone</label>
						<div class="controls">
							<input type="text" class="input-large" required="required" name="telefone" id="telefone" value="<?php echo $participante->telefone; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="data_nascimento" >Data de Nascimento</label>
						<div class="controls">
							<input type="text" data-mask="99/99/9999" class="input-large" required="required" name="data_nascimento" id="data_nascimento" value="<?php echo $participante->data_nascimento; ?>" />
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php foreach($listaSexos as $indice => $label) : ?>
								<option <?php echo ($participante->sexo == $indice) ? 'selected="selected"' : ''; ?> value="<?php echo $indice; ?>" ><?php echo $label; ?></option>
							<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" data-mask="999.999.999-99" class="input-large" required="required" name="cpf" id="cpf" value="<?php echo $participante->cpf; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="rg" >RG</label>
						<div class="controls">
							<input type="text" class="input-large" name="rg" id="rg" value="<?php echo $participante->rg; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="orgao_emissor" >Orgão Emissor</label>
						<div class="controls">
							<input type="text" class="input-large" name="orgao_emissor" id="orgao_emissor" value="<?php echo $participante->orgao_emissor; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="CEP" >CEP</label>
						<div class="controls">
							<input type="text" data-mask="99999-999" class="input-large" name="cep" id="cep_participante" value="<?php echo $participante->cep; ?>" />
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php foreach($listaEstados as $estado) : ?>
								<option <?php echo ($participante->estado == $estado->id) ? 'selected="selected"' : ''; ?> value="<?php echo $estado->id; ?>" ><?php echo $estado->nome; ?></option>
							<?php endforeach; ?>
							</select>
						</div>
					</div>
						...
						<div class="controls">
							<select required="required" name="cidade" id="cidade">
								<?php foreach($listaCidades as $cidade) : ?>
									<option <?php echo ($participante->cidade == $cidade->id) ? 'selected="selected"' : ''; ?> value="<?php echo $cidade->id; ?>" ><?php echo $cidade->nome; ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-large" required="required" name="bairro" id="bairro" value="<?php echo $participante->bairro; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="logradouro" >Logradouro</label>
						<div class="controls">
							<input type="text" class="input-large" required="required" name="logradouro" id="logradouro" value="<?php echo $participante->logradouro; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="numero" >Número</label>
						<div class="controls">
							<input type="text" class="input-large" required="required" name="numero" id="numero" value="<?php echo $participante->numero; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="complemento" >Complemento</label>
						<div class="controls">
							<input type="text" class="input-large" name="complemento" id="complemento" value="<?php echo $participante->complemento; ?>" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="instituicao" >Instituição</label>
						<div class="controls">
							<input type="text" class="input-large" required="required" name="instituicao" id="instituicao" value="<?php echo $participante->instituicao; ?>" />
						</div>
					</div>
          <div class="control-group">
						<label class="control-label" for="voucher" >Voucher</label>
						<div class="controls">
							<input type="text" class="input-large" name="voucher" id="voucher" value="<?php echo $participante->voucher; ?>" />
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php foreach($listaAreasAtuacao as $indice => $label) : ?>
								<option <?php echo ($participante->area_atuacao == $indice) ? 'selected="selected"' : ''; ?> value="<?php echo $indice; ?>" ><?php echo $label; ?></option>
							<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php foreach($listaProfissoes as $profissao) : ?>
								<option <?php echo ($participante->profissao == $profissao->id) ? 'selected="selected"' : ''; ?> value="<?php echo $profissao->id; ?>" ><?php echo $profissao->nome; ?></option>
							<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="control-group" <?php echo (empty($participante->outra_profissao)) ? 'style="display:none;"' : ''; ?> >
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php foreach($listaGrausInstrucao as $indice => $label) : ?>
								<option <?php echo ($participante->grau_instrucao == $indice) ? 'selected="selected"' : ''; ?> value="<?php echo $indice; ?>" ><?php echo $label; ?></option>
							<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php foreach($listaTamanhosCamisa as $indice => $label) : ?>
								<option <?php echo ($participante->tamanho_camisa == $indice) ? 'selected="selected"' : ''; ?> value="<?php echo $indice; ?>" ><?php echo $label; ?></option>
							<?php endforeach; ?>
							</select>
						</div>
					</div>

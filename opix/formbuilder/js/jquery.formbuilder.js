	...
	$.fn.formbuilder = function (options) {
		...
		var defaults = {
			...
			messages: {
				...
				text				: "Campo de Texto",
				title				: "Título",
				paragraph			: "Caixa de Texto",
				checkboxes			: "Opções Múltiplas - Escolhas Múltiplas",
				radio				: "Opções Múltiplas - Escolha Única",
				select				: "Caixa de Seleção",
				text_field			: "Campo de Texto",
				label				: "Rótulo",
				paragraph_field		: "Caixa de Texto",
				select_options		: "Caixa de Seleção",
				add					: "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",
				checkbox_group		: "Opções Múltiplas - Escolhas Múltiplas",
				remove_message		: "Tem certeza que quer remover esse campo?",
				remove				: "",
				radio_group			: "Opções Múltiplas - Escolha Única",
				selections_message	: "Permitir múltiplas seleções",
				hide				: " ",
		...
		return this.each(function () {
			...
			$('.frmb').delegate('.add_ck', 'click', function () {
				$(this).parents('.fields').children(':not(.add-area)').children('ol').append(checkboxFieldHtml());
				return false;
			});
			// Attach a callback to add new options
			$('.frmb').delegate('.add_opt', 'click', function () {
				$(this).parents('.fields').children(':not(.add-area)').children('ol').append(selectFieldHtml('', false));
				return false;
			});
			// Attach a callback to add new radio fields
			$('.frmb').delegate('.add_rd', 'click', function () {
				$(this).parents('.fields').children(':not(.add-area)').children('ol').append(radioFieldHtml(false, $(this).parents('.frm-holder').attr('id')));
				return false;
			});
